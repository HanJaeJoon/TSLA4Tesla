...
갱신: 2026-08-19 (출시 완료 확인, Play Console/AdMob 실제 상태 반영)
...
- [ ] **AdMob 앱 인증 통과** - 현재 상태: `광고 게재가 제한됨 - Verify app to lift limit`
  - 전제 조건은 모두 충족됨 (app-ads.txt 서빙 + Play 등록정보에 도메인 반영 확인)
  - AdMob > 앱 > 확인할 앱 또는 Verify app 링크에서 "업데이트 확인"을 눌러 재크롤링
  - 인증 전까지 배너 광고가 실제로 게재되지 않음
